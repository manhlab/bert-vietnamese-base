...
from tokenization import VinaBasicTokenizer

CONTROL_SYMBOLS = ['[CLS]', '[SEP]', '[MASK]']
def main(args):
    tokenizer = VinaBasicTokenizer(do_lower_case=args.do_lower_case,
                                    vina_dict_path=args.vina_dict_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_file', type=str, required=True,help='Output vocabulary file.')
    parser.add_argument('--subword_type', choices=('bpe', 'char', 'word'),help='Subword type. ("bpe", "char", or "word")')
    parser.add_argument('--vocab_size', type=int, default=32000,help='WordPiece vocabulary size. [32000]')
    parser.add_argument('--sentence_size', type=int, default=1000000,help='Limit the input sentence size. [1000000]')
    parser.add_argument('--do_lower_case', action='store_true',help='Lowercase the input text.')
    parser.add_argument('--vina_dict_path', type=str, help='Path to Vina custom dictionary.')
