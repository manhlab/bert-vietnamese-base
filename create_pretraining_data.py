...
flags.DEFINE_string("vina_dict_path", None,
                    "Path to a Vina custom dictionary.")
...
def main(_):
  ...
  if FLAGS.subword_type == "bpe":
    tokenizer = tokenization.VinaBertTokenizer(
      vocab_file=FLAGS.vocab_file, do_lower_case=FLAGS.do_lower_case,
      vina_dict_path=FLAGS.vina_dict_path)
  elif FLAGS.subword_type == "char":
    tokenizer = tokenization.VinaCharacterBertTokenizer(
      vocab_file=FLAGS.vocab_file, do_lower_case=FLAGS.do_lower_case,
      vina_dict_path=FLAGS.vina_dict_path)
  elif FLAGS.subword_type == "word":
    tokenizer = tokenization.VinaBertTokenizer(
      vocab_file=FLAGS.vocab_file, do_lower_case=FLAGS.do_lower_case,
      do_wordpiece_tokenize=False, vina_dict_path=FLAGS.vina_dict_path)
  else:
